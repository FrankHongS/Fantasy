...
/**
 *
 * copied from {@link com.google.android.material.tabs.TabLayoutMediator}
 * 增加的逻辑：
 * 当手动滑动时，支持平滑滑动；当选中Tab滑动（代码滑动）时，直接切换
 * 即ViewPager的两种滑动情况可以对滑动动画进行不同设置
 * 原代码没有暴露接口，所以直接复制修改
 */
public final class TabLayoutMediator {
    ...
    public TabLayoutMediator(
            ...
            @NonNull com.google.android.material.tabs.TabLayoutMediator.TabConfigurationStrategy tabConfigurationStrategy) {
    ...
    private static class ViewPagerOnTabSelectedListener implements TabLayout.OnTabSelectedListener {
        ...
        public void onTabSelected(@NonNull TabLayout.Tab tab) {
            ...
            boolean fromDrag = false;
            if (tag instanceof Boolean) {
                fromDrag = (boolean) tag;
                tab.setTag(null);
            }
            if (fromDrag) {
