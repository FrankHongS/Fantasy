...
import com.hon.fantasy.dataloader.FolderLoader;
...
public class FolderAdapter extends BaseSongAdapter<FolderAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final FolderAdapter.ItemHolder itemHolder, int i) {
        ...
        if (localItem.isDirectory()) {
            ...
            ImageLoader.getInstance().displayImage(FantasyUtils.getAlbumArtUri(song.albumId).toString(),
                    itemHolder.albumArt,
            ...
            if (f.isDirectory() && updateDataSetAsync(f)) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        playAll(mContext, ret, current, -1, FantasyUtils.IdType.NA,
