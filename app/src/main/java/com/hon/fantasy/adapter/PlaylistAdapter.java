...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        itemHolder.artist.setText(" " + String.valueOf(songCountInt) + " " + mContext.getString(R.string.songs) + " - " + FantasyUtils.makeShortTimeString(mContext,totalRuntime));
                ...
                switch (position) {
                    case 0:
                        ...
                        if (songCountInt != 0) {
                            ...
                            return FantasyUtils.getAlbumArtUri(firstAlbumID).toString();
                        } else return "nosongs";
                    case 1:
