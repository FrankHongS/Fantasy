...
import com.hon.fantasy.adapter.AlbumSongsAdapter;
import com.hon.fantasy.dataloader.AlbumLoader;
import com.hon.fantasy.dataloader.AlbumSongLoader;
...
import com.hon.fantasy.utils.ATEUtils;
import com.hon.fantasy.utils.Constants;
import com.hon.fantasy.utils.FabAnimationUtils;
...
public class AlbumDetailFragment extends Fragment {
        ...
        ImageUtils.loadAlbumArtIntoView(album.id, albumArt, new ImageLoadingListener() {
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        ...
                        MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(context)
                                ...
                                .setColor(FantasyUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                  ...
                                                  public void onGenerated(Palette palette) {
                                                      ...
                                                      if (getActivity() != null) {
                                                          MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(getActivity())
                                                                  ...
                                                                  .setSizeDp(30);
                                                          if (primaryColor != -1) {
                                                              builder.setColor(FantasyUtils.getBlackWhiteColor(primaryColor));
                                                              ATEUtils.setFabBackgroundTint(fab, primaryColor);
                                                              fab.setImageDrawable(builder.build());
                                                          } else {
                                                              if (context != null) {
                                                                  ATEUtils.setFabBackgroundTint(fab, Config.accentColor(context, Helpers.getATEKey(context)));
                                                                  builder.setColor(FantasyUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                  fab.setImageDrawable(builder.build());
                                                              }
                                                          }
                                                      }
    ...
    private void setAlbumDetails() {
        ...
        String songCount = FantasyUtils.makeLabel(getActivity(), R.plurals.Nsongs, album.songCount);
