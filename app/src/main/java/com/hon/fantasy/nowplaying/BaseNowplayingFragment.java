...
import com.hon.fantasy.adapter.BaseQueueAdapter;
...
import com.hon.fantasy.timely.TimelyView;
...
import com.hon.fantasy.widget.CircularSeekBar;
import com.hon.fantasy.widget.PlayPauseButton;
import com.hon.fantasy.widget.PlayPauseDrawable;
        ...
        public void run() {
            ...
            if (mProgress != null) {
                ...
                if (elapsedtime != null && getActivity() != null)
                    elapsedtime.setText(FantasyUtils.makeShortTimeString(getActivity(), position / 1000));
            }
            overflowcounter--;
